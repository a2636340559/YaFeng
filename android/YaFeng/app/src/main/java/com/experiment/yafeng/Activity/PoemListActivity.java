...
//        poemListView.setEmptyView(findViewById(R.id.empty_imageview_iv));
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(RefreshLayout refreshlayout) {
                if(from.equals("collect"))
                {
                    ...
                    Gson gson=new Gson();
                    List<Poetry> poetries=gson.fromJson(temp,new TypeToken<List<Poetry>>(){}.getType());
                    poetryList=poetries;
                    poemListAdapter=new PoemListAdapter(poetryList,getContext());
                    poemListView.setAdapter(poemListAdapter);
    ...
    {
        isLoad = false;
        String url="http://39.106.193.194:8080/yafeng-1.0/poetry/getPoetryByTag?tag="+tag
    ...
    {
        String url="http://39.106.193.194:8080/yafeng-1.0/poetry/getPoetryBySearch?key="
